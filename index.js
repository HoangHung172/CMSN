const contentLetterSrart_actived = "Konichiwa chị tui :D !" //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc chị Như tuổi mới lúc nào cũng vui vẻ và sớm trở thành phú bà nhé hehe" //Nội dung của bức thư
...
document.addEventListener('click', function() {
    var audio = document.getElementById('background-audio'); // Đảm bảo bạn có thẻ <audio> với id là 'background-audio'

    // Phát nhạc nếu nhạc chưa phát
    if (audio.paused) {
        audio.play();
    }

    // Sau khi nhạc đã bắt đầu phát, loại bỏ sự kiện click để không phát lại nhiều lần
